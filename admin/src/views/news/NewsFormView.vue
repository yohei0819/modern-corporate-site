...
onMounted(async () => {
  if (isEdit.value) {
    ...
    try {
      ...
      if (n.thumbnail_url) thumbnailPreview.value = n.thumbnail_url;
    } catch {
      ...
      <div class="grid grid-cols-1 gap-5 md:grid-cols-2">
        <div class="md:col-span-2">
          ...
          <input
            v-model="form.title"
            type="text"
            class="block w-full rounded-lg border border-gray-300 px-3 py-2 text-sm focus:border-blue-500 focus:ring-1 focus:ring-blue-500 outline-none"
          />
          <p v-if="fieldError('title')" class="mt-1 text-xs text-red-600">
            {{ fieldError('title') }}
          </p>
        </div>
        <div>
        ...
        <div class="md:col-span-2">
          ...
          <textarea
            ...
            class="block w-full rounded-lg border border-gray-300 px-3 py-2 text-sm focus:border-blue-500 focus:ring-1 focus:ring-blue-500 outline-none"
          />
          <p v-if="fieldError('excerpt')" class="mt-1 text-xs text-red-600">
            {{ fieldError('excerpt') }}
          </p>
        </div>
        <div class="md:col-span-2">
          ...
          <textarea
            ...
            class="block w-full rounded-lg border border-gray-300 px-3 py-2 text-sm focus:border-blue-500 focus:ring-1 focus:ring-blue-500 outline-none"
          />
          <p v-if="fieldError('body')" class="mt-1 text-xs text-red-600">
            {{ fieldError('body') }}
          </p>
        </div>
        <div class="md:col-span-2">
          ...
          <div v-if="uploadProgress > 0 && loading" class="mt-2 w-full max-w-xs">
            <div class="w-full bg-gray-200 rounded-full h-1.5">
              <div
                class="bg-blue-600 h-1.5 rounded-full upload-progress-bar"
          ...
          <img
            ...
            class="mt-2 h-24 object-cover rounded-lg border border-gray-200"
          />
        </div>
        <div>
